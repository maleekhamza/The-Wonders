      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="page4C" class="logo">
                <img style="width: 100px;height: 100px;margin-left: 300px; border-radius: 50%;" src="/img/4c.jpg">
              <h4>Center<span> 4C</span></h4>
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li class="scroll-to-section"><a href="page4C" class="active">Home</a></li>
