      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="gaminglab" class="logo">
                <img style="width: 100px;height: 100px;margin-left: 300px; border-radius: 50%;" src="/img/GamingLab.jpg">
              <h4>gaming<span> lab</span></h4>
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li class="scroll-to-section"><a href="gaminglab" class="active">Home</a></li>
